...
public class Exercise_07_16 {
	public static void main(String[] args)
	{
		...
		long endTime = System.currentTimeMillis();
		long executionTime = endTime - startTime;
		System.out.println("Execution time of invoking the linearSearch: "+executionTime);
		...
		System.out.println("Execution time of invoking the binarySearch is: "+executionTime+" ");
	}
